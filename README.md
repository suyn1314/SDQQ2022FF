...
> "CompoundShape (Circle (Vector (1.34, -2.00)), Rectangle (Vector ((-3.00, 3.00), (-1.00, 3.00)), Vector ((-1.00, 3.00), (-1.00, -1.00))))"
```
...
For the same case, the BFS order should be: *Tri, C2, C3, Tri, Rect, Cir1, and Cir2*.
